...
ALTER TABLE ct_authorities
  ADD CONSTRAINT ct_authorities_pk PRIMARY KEY (nct_id) USING INDEX TABLESPACE ernie_index_tbs;
-- endregion

-- region ct_collaborators
ALTER TABLE ct_collaborators
  ADD CONSTRAINT ct_collaborators_pk PRIMARY KEY (nct_id, agency) USING INDEX TABLESPACE ernie_index_tbs;
-- 1.3s
-- endregion

-- region ct_conditions
ALTER TABLE ct_conditions
  ADD CONSTRAINT ct_conditions_pk PRIMARY KEY (nct_id, condition) USING INDEX TABLESPACE ernie_index_tbs;
-- 6.4s
-- endregion

-- region ct_condition_browses
ALTER TABLE ct_condition_browses
  ADD CONSTRAINT ct_condition_browses_pk PRIMARY KEY (nct_id, mesh_term) USING INDEX TABLESPACE ernie_index_tbs;
-- 7.6s
-- endregion
