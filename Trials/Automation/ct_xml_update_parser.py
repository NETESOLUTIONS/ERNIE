...
Modified: 05/19/2016, Lindsay Wan, added documentation
          11/15/2016, Lindsay Wan, deleted useless database connection
...
list_table = ['new_ct_clinical_studies', 'new_ct_secondary_ids', \
              'new_ct_collaborators', 'new_ct_authorities', \
              'new_ct_outcomes', 'new_ct_conditions', 'new_ct_arm_groups', \
              'new_ct_interventions', \
              'new_ct_intervention_arm_group_labels', \
              'new_ct_intervention_other_names', 'new_ct_overall_officials', \
              'new_ct_overall_contacts', 'new_ct_locations', \
              'new_ct_location_investigators', 'new_ct_location_countries', \
              'new_ct_links', 'new_ct_condition_browses', \
              'new_ct_intervention_browses', 'new_ct_references', \
              'new_ct_publications', 'new_ct_keywords']
