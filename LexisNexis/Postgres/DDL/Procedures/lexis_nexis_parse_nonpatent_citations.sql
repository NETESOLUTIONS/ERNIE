...
$$
  BEGIN
    INSERT INTO lexis_nexis_nonpatent_literature_citations(country_code,doc_number,kind_code,citation_text,scopus_url)
    SELECT
          ...
          xmltable.scopus_url
     FROM
     XMLTABLE('//bibliographic-data/references-cited/citation/nplcit' PASSING input_xml
              COLUMNS
