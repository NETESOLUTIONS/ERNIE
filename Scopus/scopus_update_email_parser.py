...
def scopus_zip_file_name_date_edit(scopus_zip_file_name):
    ...
    date_field = scopus_zip_file_name[(scopus_zip_file_name.index('_ANI-ITEM')-8):scopus_zip_file_name.index('_ANI-ITEM')]

    first_part = scopus_zip_file_name[:(scopus_zip_file_name.index('_ANI-ITEM')-8)] 
    last_part = scopus_zip_file_name[scopus_zip_file_name.index('_ANI-ITEM'):]
