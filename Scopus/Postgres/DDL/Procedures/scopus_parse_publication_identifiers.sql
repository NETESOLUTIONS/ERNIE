...
AS $$
  BEGIN
      ...
      ON CONFLICT (scp, document_id_type, document_id) DO UPDATE SET scp=excluded.scp, document_id=excluded.document_id, document_id_type=excluded.document_id_type;
  END;
  $$
LANGUAGE plpgsql;
