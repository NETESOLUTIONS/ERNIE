...
AS $$
  BEGIN
    ...
    ON CONFLICT UPDATE SET scp=excluded.scp, author_seq=excluded.author_seq, auid=excluded.auid,
    ...
    ON CONFLICT UPDATE SET scp=excluded.scp, affiliation_no=excluded.affiliation_no, afid=excluded.afid,
    ...
    ON CONFLICT UPDATE SET t1.scp=excluded.scp, t1.author_seq=excluded.author_seq, t2.affiliation_no=excluded.affiliation_no;
