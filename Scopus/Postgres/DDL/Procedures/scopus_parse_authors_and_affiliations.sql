...
AS $$
  BEGIN
    ...
    ON CONFLICT (scp, author_seq) DO UPDATE SET scp=excluded.scp, author_seq=excluded.author_seq, auid=excluded.auid,
    ...
    ON CONFLICT (scp, affiliation_no) DO UPDATE SET scp=excluded.scp, affiliation_no=excluded.affiliation_no, afid=excluded.afid,
