...
$$
  BEGIN
    ...
    ON CONFLICT UPDATE SET scp=excluded.scp, ref_sgr=excluded.ref_sgr, citation_text=excluded.citation_text;
...
$$
  ...
  BEGIN
      ...
      LOOP
        BEGIN
          INSERT INTO scopus_references VALUES (row.scp,row.ref_sgr,row.citation_text) ON CONFLICT UPDATE SET row.scp=excluded.scp,
