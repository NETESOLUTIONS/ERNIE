...
<<<<<<< HEAD
create procedure scopus_parse_source_and_conferences(scopus_doc_xml xml)
    language plpgsql
as
$$
DECLARE
...
>>>>>>> cc95278e94a4a355d2c5d96b35d4c3405cd305ca
BEGIN
    BEGIN
...
alter procedure scopus_parse_source_and_conferences(xml) owner to sitaram;
