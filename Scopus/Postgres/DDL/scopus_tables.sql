...
CREATE TABLE IF NOT EXISTS scopus_publication_identifiers (
    ...
    DEFAULT
    now(
), CONSTRAINT scopus_publiaction_identifiers_pk PRIMARY KEY (
    scp,
    document_id_type,
    document_id
) --
...
CREATE TABLE IF NOT EXISTS scopus_abstracts (
    ...
    DEFAULT
    now(
), CONSTRAINT scopus_abstracts_pk PRIMARY KEY (
    scp,
    abstract_language
)
USING INDEX
...
CREATE TABLE IF NOT EXISTS scopus_titles (
    ...
    DEFAULT
    now(
), CONSTRAINT scopus_titles_pk PRIMARY KEY (
    scp,
    LANGUAGE
)
USING INDEX
...
CREATE TABLE IF NOT EXISTS scopus_keywords (
    ...
    DEFAULT
    now(
), CONSTRAINT scopus_keywords_pk PRIMARY KEY (
    scp,
    keyword
)
USING INDEX
...
CREATE TABLE IF NOT EXISTS scopus_chemical_groups (
    ...
    DEFAULT
    now(
), CONSTRAINT scopus_chemical_groups_pk PRIMARY KEY (
    scp,
    chemical_name,
    cas_registry_number
) --
