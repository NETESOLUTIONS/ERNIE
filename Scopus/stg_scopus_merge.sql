...
SELECT
scp, author_seq, auid, author_indexed_name, author_surname, author_given_name,
                               author_initials, author_e_address, author_rank
...
ON CONFLICT (scp, author_seq) DO UPDATE SET auid=excluded.auid,
                                                                  ...
                                                                  author_rank=excluded.author_rank;    -- scopus_affiliations
---------------------------------------
insert into scopus_affiliations(scp, affiliation_no, afid, dptid, city_group, state, postal_code, country_code,
                                    country)
SELECT
scp, affiliation_no, afid, dptid, city_group, state, postal_code, country_code,
                                    country
...
select
scp, chemicals_source,chemical_name, cas_registry_number
...
ON CONFLICT (scp) DO UPDATE SET grant_text=excluded.grant_text; INSERT
...
SELECT
class_type, class_code, description
...
SELECT
scp, sgr, correspondence_person_indexed_name, correspondence_city,
                                            correspondence_country, correspondence_e_address, citation_type
...
select
ernie_source_id, issn, issn_type
...
select
conf_code, conf_name, conf_address, conf_city, conf_postal_code,
                                         conf_start_date,
                                         conf_end_date, conf_number, conf_catalog_number
...
INSERT INTO scopus_conf_proceedings(ernie_source_id, conf_code, conf_name, proc_part_no, proc_page_range,
                                        proc_page_count)
select
ernie_source_id, conf_code, conf_name, proc_part_no, proc_page_range,
                                        proc_page_count
...
INSERT INTO scopus_conf_editors(ernie_source_id, conf_code, conf_name, indexed_name, role_type,
    ...
    select
    ernie_source_id, conf_code, conf_name, indexed_name, role_type,
                                    initials, surname, given_name, degree, suffix
