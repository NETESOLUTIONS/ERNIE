...
$$;
-----------------------------------------
create procedure stg_scopus_merge_authors_and_affiliations()
    language plpgsql
as
$$
BEGIN
...
create procedure stg_scopus_merge_authors_chemical_groups()
    language plpgsql
as
$$
BEGIN
...
create procedure stg_scopus_merge_chemical_groups()
language plpgsql
AS
$$
BEGIN
