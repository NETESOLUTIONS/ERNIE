...
\copy (select pmid from ct_references where nct_id in (select nct_id from ipilimumab_ct) 
order by pmid) to '/home/chackoge/ERNIE/Analysis/ipilimumab/ipilimumab_ct_reference_pmid';

-- get pmids for ipilimumab_ct_publication_pmid file
\copy (select pmid from ct_publications where nct_id in (select nct_id from ipilimumab_ct) 
order by pmid) TO '/home/chackoge/ERNIE/Analysis/ipilimumab/ipilimumab_ct_publication_pmid';
