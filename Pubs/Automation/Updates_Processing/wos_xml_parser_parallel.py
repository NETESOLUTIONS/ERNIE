...
csvfile_load = open(xml_csv_dir+input_filename[:-4]+'_load.sh', 'w')
...
copy_command = "psql -d ernie -c \"copy temp_wos_publications from '"+xml_csv_dir+input_filename[:-4]+"_publication.csv'"+" delimiter ',' CSV;\" &\n"
csvfile_load.write((copy_command))
copy_command = "psql -d ernie -c \"copy temp_wos_references from '"+xml_csv_dir+input_filename[:-4]+"_reference.csv'"+" delimiter ',' CSV; \" &\n"
csvfile_load.write((copy_command))
copy_command = "psql -d ernie -c \"copy temp_wos_grants from '"+xml_csv_dir+input_filename[:-4]+"_grant.csv'"+" delimiter ',' CSV;\" &\n"
csvfile_load.write((copy_command))
copy_command = "psql -d ernie -c \"copy temp_wos_addresses from '"+xml_csv_dir+input_filename[:-4]+"_address.csv'"+" delimiter ',' CSV;\" &\n"
csvfile_load.write((copy_command))
copy_command = "psql -d ernie -c \"copy temp_wos_authors from '"+xml_csv_dir+input_filename[:-4]+"_author.csv'"+" delimiter ',' CSV; \" &\n"
csvfile_load.write((copy_command))
copy_command = "psql -d ernie -c \"copy temp_wos_document_identifiers from '"+xml_csv_dir+input_filename[:-4]+"_dois.csv'"+" delimiter ',' CSV; \" &\n"
csvfile_load.write((copy_command))
copy_command = "psql -d ernie -c \"copy temp_wos_abstracts from '"+xml_csv_dir+input_filename[:-4]+"_abstract.csv'"+" delimiter ',' CSV; \" &\n"
csvfile_load.write((copy_command))
copy_command = "psql -d ernie -c \"copy temp_wos_keywords from '"+xml_csv_dir+input_filename[:-4]+"_keyword.csv'"+" delimiter ',' CSV; \" &\n"
csvfile_load.write((copy_command))
copy_command = "psql -d ernie -c \"copy temp_wos_titles from '"+xml_csv_dir+input_filename[:-4]+"_title.csv'"+" delimiter ',' CSV; \" &\n\n wait \n"
csvfile_load.write((copy_command))
