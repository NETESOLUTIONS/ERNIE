...
create table temp_update_wosid tablespace wos_load_tbs as
  select source_id from new_wos_publications;
create index temp_update_wosid_idx on temp_update_wosid
  using hash (source_id) tablespace wos_load_index_tbs;

drop table if exists temp_update_wosid_1;
create table temp_update_wosid_1 tablespace wos_load_tbs as
select source_id from temp_update_wosid;

drop table if exists temp_update_wosid_2;
create table temp_update_wosid_2 tablespace wos_load_tbs as
select source_id from temp_update_wosid;

drop table if exists temp_update_wosid_3;
create table temp_update_wosid_3 tablespace wos_load_tbs as
select source_id from temp_update_wosid;

drop table if exists temp_update_wosid_4;
create table temp_update_wosid_4 tablespace wos_load_tbs as
select source_id from temp_update_wosid;
...
create table temp_replace_wosid tablespace wos_load_tbs as
...
--create table temp_update_wosid_grants tablespace wos_load_tbs as
--select source_id from temp_update_wosid;

--drop table if exists temp_update_wosid_keywords;
--create table temp_update_wosid_keywords tablespace wos_load_tbs as
--select source_id from temp_update_wosid;

--drop table if exists temp_update_wosid_publications;
--create table temp_update_wosid_publications tablespace wos_load_tbs as
--select source_id from temp_update_wosid;

--drop table if exists temp_update_wosid_titles;
--create table temp_update_wosid_titles tablespace wos_load_tbs as
--select source_id from temp_update_wosid;

--drop table if exists temp_replace_wosid_1;
--  create table temp_replace_wosid_1 tablespace wos_load_tbs as
--  select source_id from temp_replace_wosid;

--  drop table if exists temp_replace_wosid_2;
--  create table temp_replace_wosid_2 tablespace wos_load_tbs as
--  select source_id from temp_replace_wosid;

--  drop table if exists temp_replace_wosid_3;
--  create table temp_replace_wosid_3 tablespace wos_load_tbs as
--  select source_id from temp_replace_wosid;

--  drop table if exists temp_replace_wosid_4;
--  create table temp_replace_wosid_4 tablespace wos_load_tbs as
--  select source_id from temp_replace_wosid;

--drop table if exists temp_replace_wosid_grants;
--create table temp_replace_wosid_grants tablespace wos_load_tbs as
--select source_id from temp_replace_wosid;

--drop table if exists temp_replace_wosid_keywords;
--create table temp_replace_wosid_keywords tablespace wos_load_tbs as
--select source_id from temp_replace_wosid;

--drop table if exists temp_replace_wosid_publications;
--create table temp_replace_wosid_publications tablespace wos_load_tbs as
--select source_id from temp_replace_wosid;

--drop table if exists temp_replace_wosid_titles;
--create table temp_replace_wosid_titles tablespace wos_load_tbs as
--select source_id from temp_replace_wosid;
