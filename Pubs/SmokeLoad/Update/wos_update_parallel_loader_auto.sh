...
#psql -d pardi -f analyze_wos_tables.sql
...
do
  ...
  psql -d pardi -f analyze_new_wos_tables.sql
  ...
  date >> time_keeper.txt
  psql -d pardi -f wos_parallel_update_preprocess.sql
...
psql -d pardi -f wos_delete_tables_preprocess.sql -v delete_csv="'"$c_dir"del_wosid.csv'"

wait

psql -d pardi -f wos_delete_abstracts.sql &
psql -d pardi -f wos_delete_addresses.sql &
psql -d pardi -f wos_delete_authors.sql &
psql -d pardi -f wos_delete_doc_iden.sql &
psql -d pardi -f wos_delete_grants.sql &
psql -d pardi -f wos_delete_keywords.sql &
psql -d pardi -f wos_delete_publications.sql &
psql -d pardi -f wos_delete_references.sql &
psql -d pardi -f wos_delete_titles.sql &
...
psql -d pardi -c "update update_log_wos set last_updated = current_timestamp, num_wos = (select count(1) from wos_publications) where id = (select max(id) from update_log_wos);"
