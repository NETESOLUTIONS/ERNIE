...
# Updates all table except wos_references.
  ...
  psql -d pardi -f wos_update_abstracts.sql &
  psql -d pardi -f wos_update_addresses.sql &
  psql -d pardi -f wos_update_authors.sql &
  psql -d pardi -f wos_update_doc_iden.sql &
  ...
  psql -d pardi -f wos_update_grants.sql &
  psql -d pardi -f wos_update_keywords.sql &
  psql -d pardi -f wos_update_publications.sql &
  psql -d pardi -f wos_update_titles.sql &
  ...
  psql -d pardi -f wos_parallel_update_postprocess.sql
