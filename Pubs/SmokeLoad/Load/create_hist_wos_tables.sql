...
-- original table,   hist_wos_ref, hist_wos_pub
-- delete table,     hist_wos_ref, hist_wos_pub ..
-- historical table,



SET default_tablespace = ernie_hist_wos_tbs;

CREATE TABLE hist_wos_abstracts (
    id integer,
...
CREATE TABLE hist_wos_addresses (
    id integer,
    source_id character varying(30),
...
CREATE TABLE hist_wos_document_identifiers (
    id integer,
    source_id character varying(30),
...
CREATE TABLE hist_wos_keywords (
    id integer,
    source_id character varying(30),
...
CREATE TABLE hist_wos_publications (
    id integer,
    source_id character varying(30),
...
CREATE TABLE hist_wos_references (
    id integer,
    source_id character varying(30),
