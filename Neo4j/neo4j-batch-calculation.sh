...
NAME
    ...
    neo4j-batch-calculation.sh -- batch input, perform calculations via a supplied Cypher query and export to a CSV

SYNOPSIS

    neo4j-batch-calculation.sh [-v] BATCH_OUTPUT JDBC_conn_string SQL Cypher_query_file [expected_rec_num] [batch_size]
    neo4j-batch-calculation.sh -h: display this help
...
EXAMPLES
    ...
    To find all occurrences of the word `patricia' in a file:
        ...
        $ neo4j-batch-calculation.sh /tmp/jaccard_co_citation_cond_star_i.csv
