/*
  ...
  Author: VJ Davey
*/
--TODO FINISH UPDATING THIS SCRIPT
SET search_path TO public;

--Wipe custom tables if they already exist
DROP TABLE IF EXISTS scopus_custom_affiliations CASCADE;
DROP TABLE IF EXISTS scopus_custom_documents CASCADE;
DROP TABLE IF EXISTS scopus_custom_authors CASCADE;
DROP TABLE IF EXISTS scopus_custom_author_affiliations CASCADE;
DROP TABLE IF EXISTS scopus_custom_author_documents CASCADE;
DROP TABLE IF EXISTS scopus_custom_document_affiliations CASCADE;
DROP TABLE IF EXISTS scopus_custom_document_citations CASCADE;

/*
  Create main tables
*/
CREATE TABLE scopus_custom_affiliations(
...
CREATE TABLE scopus_custom_documents(
...
CREATE TABLE scopus_custom_authors(
...
CREATE TABLE scopus_custom_author_affiliations(
  author_id varchar NOT NULL,
  affiliation_id varchar NOT NULL,
  PRIMARY KEY(author_id, affiliation_id)
);

CREATE TABLE scopus_custom_author_documents(
  author_id varchar NOT NULL,
  scopus_id varchar NOT NULL,
  PRIMARY KEY(author_id, scopus_id)
);

CREATE TABLE scopus_custom_document_affiliations(
  scopus_id varchar NOT NULL,
  affiliation_id varchar NOT NULL,
  PRIMARY KEY(scopus_id, affiliation_id)
);

CREATE TABLE scopus_custom_document_citations(
