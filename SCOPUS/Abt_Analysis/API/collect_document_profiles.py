...
# Collect base abstract profile information and mapping information from the API
for line in sys.stdin:
    sleep(0.05)
    document_id=line.strip('\n')
    doc_profile=si.abstract_retrieval(document_id,api_key,id_type='scopus_id')
    ...
    citing_document_listing=si.citing_scopus_id_search(doc_profile['scopus_id'],api_key,low_bound=low_bound,high_bound=2019)
