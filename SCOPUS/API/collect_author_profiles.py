...
# CSV file set up
profiles=['authors','author_affiliation_mappings','author_document_mappings']
...
for line in sys.stdin:
    ...
    if document_listing is None:
        continue
    for document in document_listing['documents']:
        files['author_document_mappings'].write("{},{}\n".format(auth_profile['author_id'],document).encode('utf8'))
