...
std_udf = udf(lambda x: calculate_std_dev(float(x[0]),float(x[1]),0.0), sql_type.DoubleType()) ##TODO: adjust this based on whether team wants population or sample STDDEV
