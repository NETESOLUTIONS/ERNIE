...
sudo /usr/bin/anaconda/envs/py35/bin/conda install -y --debug psycopg2
sudo /usr/bin/anaconda/envs/py35/bin/conda update -y --debug numpy
sudo /usr/bin/anaconda/envs/py35/bin/conda update -y --debug pandas
