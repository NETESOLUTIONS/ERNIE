...
rm(list=setdiff(ls(), c("cat_d95","cat_imm95","cat_metab95","cat_d95_sub_imm", "cat_d95_sub_metab")))
...
fig2 <- rbind(imm95,imm_d95,metab95,metab_d95,d95)
fig2$class <- factor(fig2$class,levels=c('all','top10','top9','top8','top7','top6','top5','top4','top3','top2','top1'))
fig2$gp <- factor(fig2$gp,levels=c("imm95","metab95","imm_wos95","metab_wos95","wos95"))
