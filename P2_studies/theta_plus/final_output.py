...
for dir_name in tmp_dir_list:
    ...
    jsd_file_name = '/home/shreya/mcl_jsd/immunology/JSD_final_result_' + dir_name + '_' + cluster_type + '.csv'
    conductance_file_name = '/home/shreya/mcl_jsd/immunology/JSD_conductance_output_' + dir_name + '_' + cluster_type + '.csv'
    ...
    save_name_full = '/home/shreya/mcl_jsd/immunology/' + dir_name + '_complete_output_full.csv'
    save_name_main = '/home/shreya/mcl_jsd/immunology/'+ dir_name + '_complete_output_main.csv'
