...
DROP TABLE IF EXISTS theta_plus.imm1988_testcase_cited;
...
DROP TABLE IF EXISTS theta_plus.imm1988_title_abstracts;
CREATE TABLE theta_plus.imm1988_title_abstracts
TABLESPACE theta_plus_tbs AS
SELECT tpin.scp,st.title,sa.abstract_text
FROM theta_plus.imm1988_nodes tpin
...
select scp,title from theta_plus.imm1988_title_abstracts limit 5;
select count(1) from theta_plus.imm1988_title_abstracts;
...
FROM theta_plus.imm1988_edge_list_unshuffled ielu
