DROP TABLE IF EXISTS theta_plus.imm1990_testcase_asjc2403;
...
DROP TABLE IF EXISTS theta_plus.imm1990_testcase_citing;
...
DROP TABLE IF EXISTS theta_plus.imm1990_testcase_asjc2403_citing_cited;
...
DELETE FROM theta_plus.imm1990_testcase_asjc2403_citing_cited
WHERE citing=cited;
...
FROM theta_plus.imm1990_testcase_asjc2403_citing_cited
UNION
...
FROM theta_plus.imm1990_nodes tpinx
