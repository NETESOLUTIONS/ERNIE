...
ON theta_plus.imm1985_testcase_citing(citing,cited)
TABLESPACE index_tbs;
...
DROP TABLE IF EXISTS theta_plus.imm1985_testcase_asjc2403_citing_cited__coresonly;
CREATE TABLE theta_plus.imm1985_testcase_asjc2403_citing_cited__coresonly
TABLESPACE theta_plus_tbs AS
