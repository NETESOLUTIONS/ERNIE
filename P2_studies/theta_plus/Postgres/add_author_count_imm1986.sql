...
-- region: add columns
ALTER TABLE imm1986_all_merged_mcl
...
WHERE imm1986_all_merged_mcl.cluster_no = authors.cluster_no
;
-- end region
...
WHERE imm1986_all_merged_mcl.cluster_no = all_authors.cluster_no;
...
UPDATE imm1986_all_merged_mcl
 ...
 FROM
    ...
    FROM
            ...
            LEFT JOIN imm1986_all_merged_mcl amu
...
WHERE imm1986_all_merged_mcl.cluster_no = articles_75.cluster_no;
...
WHERE imm1986_all_merged_mcl.cluster_no = articles_95.cluster_no;
...
WHERE imm1986_all_merged_mcl.cluster_no = articles_99.cluster_no;
...
WHERE imm1986_all_merged_mcl.cluster_no = coauthor.cluster_no;
...
WHERE imm1986_all_merged_mcl.cluster_no = dist_coauthors.cluster_no;
...
FROM
      ...
      FROM imm1986_all_merged_mcl ) prop
WHERE imm1986_all_merged_mcl.cluster_no = prop.cluster_no;
