...
COMMENT ON TABLE theta_plus.imm1996 IS
  'Seed article set for the year 1996 based on the following criteria:
...
COMMENT ON TABLE theta_plus.imm1996_cited IS
  'Cited references of all seed articles from 1996
   Note: This set is not limited to the ASJC criteria (field: immunology)';

COMMENT ON COLUMN theta_plus.imm1996_cited.citing IS 'SCP of seed articles from 1996';
...
COMMENT ON TABLE theta_plus.imm1996_citing IS
  'Citing references of all seed articles from 1996
   Note: This set is not limited to the ASJC criteria (field: immunology)';

COMMENT ON COLUMN theta_plus.imm1996_cited.citing IS 'SCP of citing references of seed articles from 1996';
COMMENT ON COLUMN theta_plus.imm1996_cited.cited IS 'SCP of seed articles from 1996';
...
COMMENT ON TABLE theta_plus.imm1996_citing_cited IS
  'union of theta_plus.imm1996_citing and theta_plus.imm1996_cited tables';
COMMENT ON COLUMN theta_plus.imm1996_cited.citing IS 'SCP of seed articles from 1996 and their citing references';
...
COMMENT ON TABLE theta_plus.imm1996_nodes IS
  'All seed articles from 1996 and their citing and cited references';
COMMENT ON COLUMN theta_plus.imm1996_nodes.scp IS
  'SCPs of all seed articles from 1996 and their citing and cited references';
