...
-- Get all ecology articles published in the year 1994
DROP TABLE IF EXISTS theta_plus_ecology.eco1994;

CREATE TABLE theta_plus_ecology.eco1994
...
CREATE INDEX eco1994_idx
    ON theta_plus_ecology.eco1994(scp)
TABLESPACE index_tbs;

-- Get all the cited references of the ecology articles published in 1994
DROP TABLE IF EXISTS theta_plus_ecology.eco1994_cited;

CREATE TABLE theta_plus_ecology.eco1994_cited
TABLESPACE theta_plus_tbs AS
SELECT eco.scp AS citing,sr.ref_sgr AS cited
FROM theta_plus_ecology.eco1994 eco
INNER JOIN public.scopus_references sr 
    ON eco.scp = sr.scp;

CREATE INDEX eco1994_cited_idx
    ON theta_plus_ecology.eco1994_cited(citing,cited)
TABLESPACE index_tbs;

-- Get all the citing references of the ecology articles published in 1994
DROP TABLE IF EXISTS theta_plus_ecology.eco1994_citing;

CREATE TABLE theta_plus_ecology.eco1994_citing 
TABLESPACE theta_plus_tbs AS
...
CREATE INDEX eco1994_citing_idx 
ON theta_plus_ecology.eco1994_citing(citing,cited)
TABLESPACE index_tbs;

-- Create table from the union of cited and citing references
DROP TABLE IF EXISTS theta_plus_ecology.eco1994_citing_cited;

CREATE TABLE theta_plus_ecology.eco1994_citing_cited
TABLESPACE theta_plus_tbs AS
SELECT DISTINCT citing,cited from theta_plus_ecology.eco1994_cited 
UNION
SELECT DISTINCT citing,cited from theta_plus_ecology.eco1994_citing;


-- clean up Scopus data
DELETE FROM theta_plus_ecology.eco1994_citing_cited
WHERE citing=cited;
...
CREATE TABLE theta_plus_ecology.eco1994_nodes
TABLESPACE theta_plus_tbs AS
SELECT DISTINCT citing AS scp
FROM theta_plus_ecology.eco1994_citing_cited
UNION
SELECT DISTINCT cited
FROM theta_plus_ecology.eco1994_citing_cited;

CREATE INDEX eco1994_nodes_idx 
    ON theta_plus_ecology.eco1994_nodes(scp);
