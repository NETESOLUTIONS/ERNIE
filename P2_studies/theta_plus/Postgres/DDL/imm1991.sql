...
-- 
-- Get all immunology articles published in the year 1991
...
--
-- Get all the cited references of the immunology articles published in 1991
...
--
-- Get all the citing references of the immunology articles published in 1991
...
TABLESPACE theta_plus_tbs AS
SELECT DISTINCT citing,cited from imm1991_cited UNION
SELECT DISTINCT citing,cited from imm1991_citing;
SELECT count(1) from imm1991_citing_cited;

-- clean up Scopus data
DELETE FROM theta_plus.imm1991_citing_cited
WHERE citing=cited;
...
ALTER TABLE theta_plus.imm1991_citing_cited
RENAME TO XX;
...
FROM theta_plus.imm1991_cluster_scp_list_mcl cslu
