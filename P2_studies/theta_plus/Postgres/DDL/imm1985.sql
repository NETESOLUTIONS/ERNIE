...
--
-- Get all immunology articles published in the year 1985
...
COMMENT ON TABLE theta_plus.imm1985 IS
  'Seed article set for the year 1985 based on the following criteria:
   ASJC Code = 2403 (Immunology)
   Publication/Citation Type = "ar" (article)
   Language = English
   Scopus Publication Type = "core"';

COMMENT ON COLUMN theta_plus.imm1985.scp IS 'SCP of seed articles for the year 1985';

--
-- Get all the cited references of the immunology articles published in 1985
...
COMMENT ON TABLE theta_plus.imm1985_cited IS
  'Cited references of all seed articles from 1985
   Note: This set is not limited to the ASJC criteria (field: immunology)';

COMMENT ON COLUMN theta_plus.imm1985_cited.citing IS 'SCP of seed articles from 1985';
COMMENT ON COLUMN theta_plus.imm1985_cited.cited IS 'SCP of cited references of seed articles from 1985';

--
-- Get all the citing references of the immunology articles published in 1985
...
COMMENT ON TABLE theta_plus.imm1985_citing IS
  'Citing references of all seed articles from 1985
   Note: This set is not limited to the ASJC criteria (field: immunology)';

COMMENT ON COLUMN theta_plus.imm1985_cited.citing IS 'SCP of citing references of seed articles from 1985';
COMMENT ON COLUMN theta_plus.imm1985_cited.cited IS 'SCP of seed articles from 1985';
...
COMMENT ON TABLE theta_plus.imm1985_citing_cited IS
  'union of theta_plus.imm1985_citing and theta_plus.imm1985_cited tables';
COMMENT ON COLUMN theta_plus.imm1985_cited.citing IS 'SCP of seed articles from 1985 and their citing references';
COMMENT ON COLUMN theta_plus.imm1985_cited.cited IS 'SCP of seed articles from 1985 and their cited references';

--
-- Get all nodes in the 1985 dataset
...
COMMENT ON TABLE theta_plus.imm1985_nodes IS
  'All seed articles from 1985 and their citing and cited references';
COMMENT ON COLUMN theta_plus.imm1985_nodes.scp IS
  'SCPs of all seed articles from 1985 and their citing and cited references';
...
TABLESPACE theta_plus_tbs AS
SELECT cslu.scp, scc.citation_count, cslu.cluster_no, scc.pub_year
FROM theta_plus.imm1985_cluster_scp_list_unshuffled cslu
LEFT JOIN public.scopus_citation_counts scc
  ON cslu.scp = scc.scp;

COMMENT ON TABLE theta_plus.imm1985_citation_counts IS
  'All seed articles from 1985 and their Scopus citation counts and publish year';
COMMENT ON COLUMN theta_plus.imm1985_citation_counts.scp IS
  'SCPs of all seed articles from 1985 and their citing and cited references';
COMMENT ON COLUMN theta_plus.imm1985_citation_counts.citation_count IS
  'Scopus citation count of all seed articles from 1985 and their citing and cited references';
COMMENT ON COLUMN theta_plus.imm1985_citation_counts.cluster_no IS
  'MCL (unshuffled) cluster number of all seed articles from 1985 and their citing and cited references';
COMMENT ON COLUMN theta_plus.imm1985_citation_counts.pub_year IS
  'Publish year of all seed articles from 1985 and their citing and cited references';