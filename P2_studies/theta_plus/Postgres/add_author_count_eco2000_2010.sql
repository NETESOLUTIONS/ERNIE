...
-- region: add columns
ALTER TABLE eco2000_2010_all_merged_mcl
...
UPDATE eco2000_2010_all_merged_mcl
...
WHERE eco2000_2010_all_merged_mcl.cluster_no = authors.cluster_no
;
-- end region
...
WHERE eco2000_2010_all_merged_mcl.cluster_no = all_authors.cluster_no;
...
UPDATE eco2000_2010_all_merged_mcl
 ...
 FROM
    ...
    FROM
            ...
            LEFT JOIN eco2000_2010_all_merged_mcl amu
...
WHERE eco2000_2010_all_merged_mcl.cluster_no = articles_75.cluster_no;
...
WHERE eco2000_2010_all_merged_mcl.cluster_no = articles_95.cluster_no;
...
WHERE eco2000_2010_all_merged_mcl.cluster_no = articles_99.cluster_no;
...
WHERE eco2000_2010_all_merged_mcl.cluster_no = coauthor.cluster_no;
...
WHERE eco2000_2010_all_merged_mcl.cluster_no = dist_coauthors.cluster_no;
...
FROM
      ...
      FROM eco2000_2010_all_merged_mcl ) prop
WHERE eco2000_2010_all_merged_mcl.cluster_no = prop.cluster_no;
