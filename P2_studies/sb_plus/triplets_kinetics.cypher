...
RETURN a.node_id AS scp1, b.node_id AS scp2, c.node_id AS scp3, a.pub_year as scp1_year, b.pub_year as scp2_year, c.pub_year as scp3_year, p.pub_year as triplet_year, COUNT(p) AS frequency
ORDER BY scp1, scp2, scp3, triplet_year;
