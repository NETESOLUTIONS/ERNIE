...
crontab -l && echo "*/10 * * * * sudo $absolute_script_dir/update_and_reboot_prod.sh >> $absolute_script_dir/log/reboot.log" | crontab -
$absolute_script_dir/update_and_reboot_prod.sh
# endregion
