...
We _are not connected_ with https://github.com/thunlp/ERNIE, which contains source code for a language representation model. However, we have exchanged cordial communications with the thunlp/ERNIE folks and wished them success.
