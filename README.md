...
An alpha-user study has nearly completed and results are expected in mid_2019 or earlier. We have recently used a combination of PostgreSQL and Spark to conduct large scale Monte Carlo simulations and results will be posted soon.
