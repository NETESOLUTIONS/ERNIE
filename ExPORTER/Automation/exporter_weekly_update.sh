...
do
    ...
    psql ernie -c """COPY temp_exporter_projects from '${file_extract}' (DELIMITER ',', FORMAT CSV, HEADER ON, QUOTE '"');"""
    ...
    psql ernie -c """COPY temp_exporter_project_abstracts from '${file}' (DELIMITER ',', FORMAT CSV, HEADER ON, QUOTE '"',  ENCODING 'latin1');"""
