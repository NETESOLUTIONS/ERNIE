...
do
    ...
    psql ernie -c " COPY temp_exporter_projects from '${file_extract}' DELIMITER ',' CSV HEADER QUOTE '\"'; "
    ...
    psql ernie -c """COPY temp_exporter_project_abstracts from '${file}' DELIMITER ',' CSV HEADER QUOTE '\"'  ENCODING 'latin1';"""
